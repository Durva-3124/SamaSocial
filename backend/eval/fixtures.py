...
FACTS: list[dict] = [
    ...
    {"id": "f25", "source": "web", "locator": "Introduction",
     "text": "Machine learning is a subset of artificial intelligence that enables systems to learn from data.",
     "keywords": ["machine learning", "artificial intelligence", "data"]},
    {"id": "f26", "source": "web", "locator": "Supervised Learning",
    ...
    {"id": "f27", "source": "web", "locator": "Unsupervised Learning",
    ...
    {"id": "f28", "source": "web", "locator": "Overfitting",
    ...
    {"id": "f29", "source": "web", "locator": "Regularisation",
    ...
    {"id": "f30", "source": "web", "locator": "Cross-Validation",
    ...
    {"id": "f31", "source": "web", "locator": "Neural Networks",
    ...
    {"id": "f32", "source": "web", "locator": "Gradient Descent",
