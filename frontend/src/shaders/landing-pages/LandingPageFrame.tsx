...
const URL_FRAME_SANDBOX = "allow-downloads allow-forms allow-modals allow-popups allow-same-origin allow-scripts allow-top-navigation-by-user-activation";
const SRCDOC_FRAME_SANDBOX = "allow-downloads allow-forms allow-modals allow-popups allow-scripts allow-top-navigation-by-user-activation";
...
export function applyBackgroundPresentation(
  ...
  if (!document?.documentElement || !frame?.contentWindow) return;
